...
with open('recording_ILPDDQN_1000car_0124_FRI_100percent_offline_DDQN.pkl', 'rb') as f:
    loss = pickle.load(f)
...
with open('recording_ILPDDQN_1000car_0126_FRI_100percent_offline_cql1000.pkl', 'rb') as f3:
...
with open('recording_ILPAC_1000car_0207_100percent_offline_fri_1.pkl', 'rb') as f3:
...
plt.title('Comparisons in RS for task 1000_CARS_Fris')
