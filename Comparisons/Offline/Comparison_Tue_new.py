...
with open('recording_ILPDDQN_1000car_0124_Tue_100percent_offline_DDQN.pkl', 'rb') as f:
    loss = pickle.load(f)
...
with open('recording_ILPDDQN_1000car_0130_Tue_100percent_offline_cql800.pkl', 'rb') as f3:
...
with open('recording_ILPAC_1000car_0207_100percent_offline_tue_1.pkl', 'rb') as f3:
...
plt.title('Comparisons in RS for task 1000_CARS_Tues')
