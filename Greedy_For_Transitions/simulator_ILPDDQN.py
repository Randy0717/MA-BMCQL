...
from Vehicles_ILPDDQN_1 import Vehicles
...
# SAVE PATH
Load_Path = 'Save/DQN_CP+TR_ILPDDQN_1000car_0118_WEDs_MPC.pt'
# POLICY_PATH = 'Save/DQN_CP+TR_ILPDDQN_1000car_0119_WEDs_MPC_fur.pt'
# training_curve_path = 'Training plot/training_ILPDDQN_1000car_0119_WEDs_MPC_fur.png'
# training_record_path = 'recording/recording_ILPDDQN_1000car_0119_WEDs_MPC_fur.pkl'
...
for eps in range(NUM_EPISODES+1):
    ...
    for delta_t in range(TEST_TIME):
        ...
        # if eps % validation_eps != 0 and delta_t % 25 == 0:
        #     Vehicles.learn()
...
# Vehicles.save(POLICY_PATH)
    ...
    if len(Vehicles.M) >= 75000:
        transition_tuples = Vehicles.M

        # 将数据序列化并保存到文件
        with open('transitions_75k_wed_20percent.pkl', 'wb') as f:
